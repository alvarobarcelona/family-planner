            ...
            {(["week", "month", "year"] as ViewMode[]).map((mode) => (
                <button
                    ...
                    className={`px-3 py-1 text-xs rounded-md capitalize transition-all ${
                        viewMode === mode ? "bg-white shadow-sm font-medium text-slate-900" : "text-gray-500 hover:text-gray-700"
                    }`}
                >
                        ...
                        <div key={dateStr} className="flex flex-col gap-1 min-h-[100px] border-r last:border-r-0 border-gray-100 px-0.5 pt-1">
                            {dayTasks.map(t => (
                                <div 
                                    ...
                                    style={{ backgroundColor: t.assignees[0]?.color || '#eee', color: '#fff' }}
                                    title={t.title}
                                >
                            ...
                            <div className="flex flex-wrap justify-center gap-0.5 mt-1 w-full">
                                {dayTasks.slice(0, 4).map((t: any) => (
                                    <div 
                                        ...
                                        style={{ backgroundColor: t.assignees[0]?.color || '#ccc' }}
                                    />
                                ))}
