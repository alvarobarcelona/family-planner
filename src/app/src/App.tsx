        ...
        <nav className="fixed bottom-4 bottom-[calc(1rem+env(safe-area-inset-bottom))] left-1/2 -translate-x-1/2 w-[95%] md:w-[60%] md:max-w-lg bg-white/90 backdrop-blur-xl border border-black/50 shadow-2xl shadow-slate-200/50 rounded-2xl z-50 transition-all duration-300">
          <div className="grid grid-cols-5 items-end justify-items-center py-2 px-1 h-[4.5rem]">
            ...
            <NavLink
              ...
              className={() => `flex flex-col items-center gap-1 pb-2 transition-all duration-300 w-full`}
            >
              {({ isActive }) => (
                <>
                  <div className={`p-2 rounded-xl transition-all duration-300 ${isActive ? "bg-indigo-100" : ""}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={`w-6 h-6 transition-all duration-300 ${isActive ? "text-indigo-600 scale-110" : "text-gray-400"}`}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                    </svg>
                  </div>
                  <span className={`text-[10px] font-semibold transition-colors duration-300 ${isActive ? "text-indigo-600" : "text-gray-400"}`}>Home</span>
                </>
              )}
            </NavLink>
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <span className={`text-[10px] font-semibold transition-colors duration-300 ${isActive ? "text-indigo-600" : "text-gray-400"}`}>Agenda</span>
                </>
              )}
            </NavLink>
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <span className={`text-[10px] font-semibold transition-colors duration-300 ${isActive ? "text-indigo-600" : "text-gray-400"}`}>Calendario</span>
                </>
              )}
            </NavLink>
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <span className={`text-[10px] font-semibold transition-colors duration-300 ${isActive ? "text-indigo-600" : "text-gray-400"}`}>Compras</span>
                </>
              )}
            </NavLink>
          </div>
